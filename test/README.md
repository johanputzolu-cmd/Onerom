...
Note that this test suite does _not_ yet use the pin mapping from [`hw-config`](/hw-config/README.md), so will report errors for hardware revisions other than `24-d`, `24-e` and `24-f`.
